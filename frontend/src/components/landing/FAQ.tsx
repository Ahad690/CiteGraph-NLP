...
const faqs = [
  ...
  { badge: "Scope", q: "Is this only for biomedical research?", a: "Clinical population extraction is biomedical-focused. A computer-science pilot separately reports explicit dataset-example counts from abstracts or linked arXiv PDFs; physics and engineering papers are marked not applicable for clinical population. Technical counts do not affect rankings." },
