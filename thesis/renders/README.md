...
|------|-------|--------------|-----------|-----------|
| `1-current-as-committed.pdf` | 121 | **no** | Times New Roman 12pt | Pandoc's default web styling, printed |
| `2-academic-serif.pdf` | 132 | yes | Times New Roman 11.5pt | Conventional university thesis |
| `3-modern-report.pdf` | 128 | yes | Cambria 11pt | Technical report |
